...
public class Photo {
    ...
    public static ArrayList<Photo> GetAllPhotos(){
        ...
        try{
            Cursor cur = LoginFragment.instance.db.rawQuery("SELECT * FROM " + LoginFragment.DBTableName, null );
    ...
    public void InsertPhoto(){
        ...
        try {
            String sqlCom = "INSERT INTO " + LoginFragment.DBTableName + " (name, date, image) VALUES(?, ?, ?)";
            SQLiteStatement statement = LoginFragment.instance.db.compileStatement(sqlCom);
